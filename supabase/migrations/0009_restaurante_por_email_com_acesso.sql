-- Aplicada em produção a 2026-09-10 (20260910102856). Trazida para o
-- repositório a 2026-09-21, tal como estava na base.
drop function if exists restaurante_por_email(text);
...
as $$
  select r.id, r.plano, r.pago_ate, r.acesso_expira_em
  from restaurants r
