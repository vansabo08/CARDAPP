...
const PASSOS = [
  ...
  },
  {
    ...
    texto:
      'Fotos, descrições e preços em Kwanzas. Marca a quantidade, escreve “sem cebola” e o carrinho vai somando.',
  },
  {
    numero: '03',
...
export default function PaginaInicial() {
  return (
    <div className="min-h-dvh bg-grafite">
      ...
      {/* Navegação                                                    */}
      {/* ---------------------------------------------------------- */}
      <header className="sticky top-0 z-50 border-b border-linha bg-grafite/85 backdrop-blur-md">
        <nav className="mx-auto flex h-16 max-w-conteudo items-center justify-between px-5 md:px-8">
          <Marca />
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link href="/tia-bela" className="font-sans text-[14px] text-tenue transition-colors hover:text-creme">
              Ver um cardápio
            </Link>
          </div>
      ...
      {/* Hero                                                         */}
      {/* ---------------------------------------------------------- */}
      <section className="mx-auto max-w-conteudo px-5 pb-24 pt-16 md:px-8 md:pb-32 md:pt-24">
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <Revelar>
              <Distintivo tom="linha">Angola · Kwanza</Distintivo>
            </Revelar>

            <Revelar atraso={60}>
              <h1 className="mt-7 max-w-[13ch] font-display text-[44px] leading-[1.02] tracking-[-0.02em] text-creme sm:text-[58px] md:text-[68px]">
                O cardápio que cabe numa <span className="text-ouro">mesa.</span>
              </h1>
            </Revelar>

            <Revelar atraso={120}>
              <p className="mt-7 max-w-[46ch] font-sans text-[17px] leading-[1.6] text-tenue">
            ...
            <Revelar atraso={240}>
              <p className="mt-6 font-sans text-[13px] text-tenue">
                Grátis para uma mesa e quinze pratos. Sem cartão de crédito.
              </p>
            </Revelar>
          </div>

          <Revelar atraso={120} className="lg:pl-8">
            <MolduraTelemovel>
              <MockupCardapio />
            </MolduraTelemovel>
          </Revelar>
      ...
      <section className="border-y border-linha">
        <div className="mx-auto grid max-w-conteudo grid-cols-1 divide-y divide-linha px-5 sm:grid-cols-3 sm:divide-x sm:divide-y-0 md:px-8">
          {[
            ...
            <Revelar key={grande} atraso={i * 60} className="px-0 py-9 sm:px-8">
              <p className="font-display text-[30px] leading-none text-creme">{grande}</p>
              <p className="mt-2 font-sans text-[14px] text-tenue">{pequeno}</p>
            </Revelar>
          ))}
        </div>
      </section>
      ...
      {/* ---------------------------------------------------------- */}
      {/* Como funciona — 3 passos com ecrãs reais                     */}
      {/* ---------------------------------------------------------- */}
      <section id="como-funciona" className="mx-auto max-w-conteudo px-5 py-24 md:px-8 md:py-32">
        <Revelar>
          <span className="etiqueta text-ouro">Como funciona</span>
          <h2 className="mt-5 max-w-[16ch] font-display text-[34px] leading-[1.08] text-creme md:text-[46px]">
        ...
        <div className="mt-16 grid gap-14 md:grid-cols-3 md:gap-8">
          ...
          <Revelar className="flex flex-col">
            ...
            <div className="mt-9 flex flex-1 items-center justify-center rounded-[12px] border border-linha bg-grafite-alto px-6 py-12">
              <CartaoMesa numero={7} />
            </div>
          </Revelar>
          ...
          <Revelar atraso={80} className="flex flex-col">
            ...
            <div className="mt-9 flex flex-1 items-center justify-center rounded-[12px] border border-linha bg-grafite-alto px-6 py-10">
              <MolduraTelemovel className="max-w-[210px]">
                <MockupCardapio />
              </MolduraTelemovel>
            </div>
          </Revelar>
      ...
      {/* A mensagem                                                   */}
      {/* ---------------------------------------------------------- */}
      <section className="border-y border-linha bg-grafite-alto">
        <div className="mx-auto grid max-w-conteudo items-center gap-14 px-5 py-24 md:grid-cols-2 md:px-8 md:py-28">
          <Revelar>
            <span className="etiqueta text-ouro">A mensagem</span>
            <h2 className="mt-5 max-w-[18ch] font-display text-[32px] leading-[1.1] text-creme md:text-[42px]">
              Escrita para ser lida na cozinha, não por um computador.
            </h2>
            <p className="mt-6 max-w-[44ch] font-sans text-[16px] leading-[1.65] text-tenue">
          ...
          <Revelar atraso={80}>
            <div className="overflow-x-auto rounded-[12px] border border-linha bg-grafite p-6">
...
— enviado via Cardapp`}
      ...
      <section id="precos" className="mx-auto max-w-conteudo px-5 py-24 md:px-8 md:py-32">
        <Revelar>
          <span className="etiqueta text-ouro">Preços</span>
          <h2 className="mt-5 font-display text-[34px] leading-[1.08] text-creme md:text-[46px]">
            ...
            <Revelar key={plano.nome} atraso={i * 70}>
              <div
                className={`flex h-full flex-col rounded-[12px] border p-7 ${
                  plano.destaque ? 'border-ouro/45 bg-ouro/[0.04]' : 'border-linha bg-grafite-alto'
                }`}
              >
                <div className="flex items-center justify-between">
                  <h3 className="font-display text-[24px] text-creme">{plano.nome}</h3>
                  {plano.destaque ? <Distintivo tom="ouro">Mais escolhido</Distintivo> : null}
                </div>

                <p className="mt-5 font-sans text-[30px] font-bold tracking-[-0.02em] text-creme">
                  {plano.preco}
                </p>
                ...
                <div className="mt-8 pt-1">
                  <Botao
                    asChild
                    largo
                    variante={plano.destaque ? 'ouro' : 'contorno'}
                    tamanho="md"
                  >
      ...
      <section className="border-t border-linha">
        <div className="mx-auto max-w-conteudo px-5 py-24 text-center md:px-8 md:py-32">
          <Revelar>
            <h2 className="mx-auto max-w-[18ch] font-display text-[36px] leading-[1.06] text-creme md:text-[52px]">
...
function PassoCabecalho({ numero, titulo, texto }: { numero: string; titulo: string; texto: string }) {
  return (
    <div>
      ...
      <h3 className="mt-3 font-display text-[23px] leading-[1.2] text-creme">{titulo}</h3>
      <p className="mt-3 font-sans text-[15px] leading-[1.6] text-tenue">{texto}</p>
    </div>
  );
}
