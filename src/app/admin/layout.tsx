...
export default async function LayoutAdmin({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-dvh">
      ...
      <header className="superficie rounded-none border-x-0 border-t-0 shadow-[inset_0_1px_0_0_rgba(250,247,242,0.11)]">
        <div className="mx-auto flex h-[68px] max-w-conteudo items-center justify-between px-5 md:px-8">
          <div className="flex items-center gap-3">
            <Marca href="/painel" />
            <Distintivo tom="laranja">Administração</Distintivo>
          </div>
          <Link
            href="/painel"
